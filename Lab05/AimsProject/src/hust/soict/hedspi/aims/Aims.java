...
public class Aims {
    ...
    public static void main(String[] args) {
        ...
        // Test with a DVD of non-positive length
        DigitalVideoDisc dvd = new DigitalVideoDisc("Invalid DVD", "Test", "Director", 0, 19.95f);
                ...
                case 2:
                    if (media instanceof Playable) {
                        try {
                            ...
                            e.printStackTrace();
                            String dialogTitle = (media instanceof DigitalVideoDisc) ? "Illegal DVD Length" : "Player Error";
